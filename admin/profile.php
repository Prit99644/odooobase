    ...
    <div class="col-md-10">
        ...
        <div class="col-md-4">
            <div class="card p-4 text-center">
                ...
                <hr>
                <p><strong>Login ID:</strong><br><span style="font-weight: bold; color: #875A7B; font-size: 1.1rem;"><?= $user['custom_id'] ?? 'Not assigned'; ?></span></p>
                <hr>
                <p><strong>Email:</strong><br><?= $user['email']; ?></p>
                <p><strong>Phone:</strong><br><?= $user['phone'] ?? 'Not provided'; ?></p>
                <p><strong>Company:</strong><br><?= $user['company_name']; ?></p>
            </div>
        </div>
...
document.getElementById('photo-input').addEventListener('change', function(e) {
    ...
    fetch('../admin/upload_profile_photo.php', {
        method: 'POST',
        body: formData
    })
